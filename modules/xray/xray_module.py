...
from app.paths import report_path
...
def save_visualisation(img_array, results, status, patient_id="PAT001"):
    ...
    plt.savefig(report_path("prana_xray_report.png"), dpi=150, bbox_inches='tight', facecolor='white')
    print("\n  Plot saved as reports/prana_xray_report.png")
