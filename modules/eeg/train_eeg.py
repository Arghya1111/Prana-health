"""
STEP 5 — Train the 1D CNN EEG classifier.

Run from project root (after inspect_dataset.py):
    python modules/eeg/train_eeg.py

Saves best model to modules/eeg/model/eeg_model.pth
"""
...
def main() -> None:
    ...
    try:
        if not META_PATH.exists():
            ...
            info = inspect_dataset(auto_download=True)
            info.save(META_PATH)
        else:
